...
renameMap[`Simple PrayerTime Reminder_${version.replace('.', '_')}_ia32.zip`] = `Portable_win-ia32_Simple PrayerTime Reminder_${version.replace('.', '_')}.zip`;
renameMap[`Simple PrayerTime Reminder_${version.replace('.', '_')}_x64.zip`] = `Portable_win-x64_Simple PrayerTime Reminder_${version.replace('.', '_')}.zip`;
